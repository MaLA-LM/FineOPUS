...
language_code="${1:-eng_Latn}"
echo "Processing language: $language_code"
input_dir="$data_dir/dcad-2000/$language_code"
out_dir="/scratch/project_462000964/FineOPUS/ablation_token"

# Create output directory if it doesn't exist
mkdir -p "$out_dir/dcad-2000/$language_code"
...
for jsonl_file in "${jsonl_files[@]}"; do
    ...
    cat > "$temp_script" << EOF
#!/bin/bash
#SBATCH --job-name=dcad_${filename}
...
output_prefix="$out_dir/dcad-2000/$language_code/$filename"
