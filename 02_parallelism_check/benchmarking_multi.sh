#!/bin/bash
#SBATCH --job-name=benchmarking_multi
#SBATCH --output=../logs/embed_eval/multi/%x_%j.out
#SBATCH --error=../logs/embed_eval/multi/%x_%j.err
...
# Build base command
BASE_CMD="srun python ./benchmarking_multi.py \
