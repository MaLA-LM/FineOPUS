...
from dataset.flores200.builder import (
    DEFAULT_FLORES_ROOT,
    limit_rows,
    load_flores200_parallel,
)
from dataset.flores200.discovery import (
    SPLIT_VALUES,
    discover_directions,
    expected_detail_rows,
)
from dataset.flores200.frames import build_frames as build_flores_frames
...
FLORES200_ADAPTER = DatasetAdapter(
    ...
    build_frames=build_flores_frames,
)
